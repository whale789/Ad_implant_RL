...
for file_name in os.listdir(folder_path):
    ...
    for i in range(len(ad_list)):
        count11,count1=count_sum(ad_list[i],ad_xy_list[i][0],ad_xy_list[i][1],ad_xy_list[i][2],ad_xy_list[i][3])
        count22,count2=count_sum(add_ad_list[i],ad_xy_list[i][0],ad_xy_list[i][1],ad_xy_list[i][2],ad_xy_list[i][3])
        ad_count[i]+=count1
